...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-3"> {/* Reduced from pt-20 to pt-16 */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> {/* Reduced py-12 to py-8 */}
        
        {/* Header - Starts immediately after navbar */}
        <div className="text-center mb-12 animate-on-scroll"> {/* Reduced mb-16 to mb-12 */}
        ...
        {/* Who We Are Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16 animate-on-scroll"> {/* Reduced gap and mb */}
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
              Who We Are
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed">
              We are a creative and results-driven Web Designing & Development Agency dedicated to helping businesses build a powerful online presence. With expertise in UI/UX design, development, branding, and digital marketing, we deliver websites that are visually stunning, user-friendly, and performance-optimized.
            </p>
            <div className="flex flex-wrap gap-3">
              {["Web Design", "Development", "UI/UX", "Branding", "Digital Marketing"].map((skill, index) => (
                <span 
                  key={index}
          ...
          <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white flex items-center justify-center group hover:shadow-2xl transition-all duration-500 hover:scale-105">
            <div className="text-center">
              <div className="text-6xl mb-4 group-hover:scale-110 transition-transform duration-300">🚀</div>
              <h3 className="text-2xl font-bold mb-4">Driven by Innovation</h3>
        ...
        {/* Mission & Vision */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16 animate-on-scroll"> {/* Reduced gap and mb */}
          {/* Mission */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-on-scroll">
          <div className="bg-gradient-to-br from-gray-900 to-blue-900 rounded-2xl p-8 text-white group hover:shadow-2xl transition-all duration-500 hover:scale-105">
            ...
            <p className="text-lg text-blue-100 leading-relaxed mb-6">
              We have experience working with startups, small businesses, e-commerce brands, and individuals, helping them turn ideas into fully functional digital products.
            </p>
